...
str(flowers)
# To acces the second elemnt in the vector, I need to use the index number 2 inside the square brackets, and that returns the values that is in that position in the vector
flowers[2]
```
...
my_results
```
No we can use this empty vector and indices inside. aloop to store results
